...
href='index.php?page=ubh_pengguna&&id=" . $data['id_pengguna'] . "'> <i class='fas fa-edit'></i> </a>";
                ?>
                  <a class="btn btn-warning" href="javascript: if (confirm('Apakah anda yakin ingin menghapus data?')) {window.location.href='proses/proses_pengguna.php?id=<?php echo $data['id_pengguna']; ?>' } else { void('') };"><i class="fas fa-trash-alt"></i></a>
                  </td>
                <?php
                  echo "</tr>";
                  $no++;
